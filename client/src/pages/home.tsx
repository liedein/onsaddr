      ...
      <main className="flex-1 flex flex-col relative">
        ...
        <div className="bg-gray-800 border-t border-gray-700 pt-5 pb-4 px-2 flex flex-col space-y-3">
          <div className="flex items-center space-x-1">
            ...
            <select className="bg-gray-100 text-gray-900 text-base px-1 py-2 rounded-md flex-[0.9] min-w-0" value={telco} onChange={e => setTelco(e.target.value)}>
            ...
            <select className="bg-gray-100 text-gray-900 text-base px-1 py-2 rounded-md flex-[1.3] min-w-0" value={target} onChange={e => setTarget(e.target.value)}>
